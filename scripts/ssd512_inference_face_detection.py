...
model_path = 'ssd512_train_models/ssd300_pascal_07+12_epoch-119_loss-3.1685_val_loss-3.1109.h5'
...
plt.savefig(os.path.join(output_image_dir, 'result_image{}.png'.format(random_index)))
