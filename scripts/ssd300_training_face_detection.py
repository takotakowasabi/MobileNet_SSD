...
model_checkpoint = ModelCheckpoint(filepath='/src/ssd300_train_models/ssd300_pascal_07+12_epoch-{epoch:02d}_loss-{loss:.4f}_val_loss-{val_loss:.4f}.h5',
                                   monitor='val_loss',
                                   verbose=1,
                                   save_best_only=True,
...
tb_cb = TensorBoard(log_dir="LOG/log10")
